...
int roughMatch(const InterestPoint* p_pointsL, unsigned int pointNumL, const InterestPoint* p_pointsR, unsigned int pointNumR, PointPair* p_pairs)
{
	...
	{
		const InterestPoint* p_matchedR = getNearestPoint(p_pointsLCur, p_pointsRStart, pointNumR, 1000000);
		if (p_matchedR == NULL)
		{
		...
		{
			const InterestPoint* p_matchedL = getNearestPoint(p_matchedR, p_pointsLStart, pointNumL, 1000000);
			if (p_matchedL == NULL)
			{
